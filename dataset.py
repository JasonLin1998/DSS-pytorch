...
class ImageData(data.Dataset):
    ...
    def __init__(self, img_root, label_root, transform, t_transform, filename=None):
        if filename is None:
            ...
            self.label_path = list(map(lambda x: os.path.join(label_root, x + 'jpg'), lines))
...
if __name__ == '__main__':
    import numpy as np
    img_root = 'D:\Documents\DSS-pytorch-master\data\RGBT\\image\RGB'
    label_root = 'D:\Documents\DSS-pytorch-master\data\RGBT\\annotation'
    filename = 'D:\Documents\DSS-pytorch-master\data\RGBT\\train_RGB.txt'
